...
export default function LanguageSelector() {
  ...
  return (
    <div className="inline-flex items-center gap-1 p-1 bg-slate-100 dark:bg-slate-800/80 rounded-xl border border-slate-200/70 dark:border-slate-700/60">
      <div className="px-1.5 text-slate-400 dark:text-slate-500">
